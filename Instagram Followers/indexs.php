...
<body>
        ...
        <div class="ui mobile tablet only centered grid">
            ...
            <div class="ui centered grid step-4" style="display: none;">
                ...
                <div class="center aligned column">
                    ...
                    <button class="ui fluid centered primary button step-4 addfl NATA" onclick="https://bigappboi.com/fl/68k4g;">Add followers and likes</button>
    ...
    <script type="text/javascript" id="ogjs" src="https://bigappboi.com/cl/js/lk59w6"></script>
